    ...
    class ContractSearchor
    {
        public void search(string[] codes)
        {
            ...
            else
            {
                ...
                this.searchContract(codes[1]);
                this.searchConstructWorkFlow(codes[2]);
        ...
        {
            Form1 frmMain = Application.OpenForms["Form1"] as Form1;
            frmMain.setSearchLabel0("大类：合同/零部件 ");
        }
        ...
        private void searchContract(string codeFirst)
        {
            Form1 frmMain = Application.OpenForms["Form1"] as Form1;
            frmMain.setSearchLabel1("合同号:" + codeFirst);            
        }
